...
> = {
  cocky: {
    ...
    tone: 'text-accent',
    voice: { stability: 0.62, similarityBoost: 0.75, speed: 0.94, style: 0.35 },
    glow: 0.9,
  },
  irritated: {
    label: 'Irritated',
    ...
    tone: 'text-primary',
    voice: { stability: 0.48, similarityBoost: 0.78, speed: 1.02, style: 0.5 },
    glow: 1.5,
  },
  enraged: {
    label: 'Enraged',
    ...
    voice: { stability: 0.28, similarityBoost: 0.85, speed: 1.12, style: 0.75 },
    glow: 2.8,
  },
  weakened: {
    label: 'Weakened',
    ...
    voice: { stability: 0.8, similarityBoost: 0.6, speed: 0.82, style: 0.2 },
    glow: 0.35,
  },
  defeated: {
    label: 'Defeated',
    ...
    tone: 'text-muted-foreground',
    voice: { stability: 0.9, similarityBoost: 0.55, speed: 0.75, style: 0.1 },
    glow: 0.1,
  },
}
